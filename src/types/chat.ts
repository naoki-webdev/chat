import type { ApiChannel, ApiMessage, ApiUser } from '../services/chatApi'
...
export const initialMessages: Record<string, Message[]> = {
  'design-system': [
    ...
    { id: 'ds-3', author: 'Naoki Sato', initials: 'NS', color: demoUser.color, time: '10:01', body: 'ありがとう。チャット画面にもそのまま適用してみました。カードの境界線だけ、もう少し薄くしてもよさそうです。', reactions: [{ emoji: '💡', count: 3 }], threadCount: 1 },
  ...
  general: [
    ...
    { id: 'g-2', author: 'Naoki Sato', initials: 'NS', color: demoUser.color, time: '08:33', body: 'おはよう！リアルタイムチャットの初期画面を作り始めます。', reactions: [{ emoji: '🚀', count: 2, reacted: true }] },
  ],
  frontend: [
  ...
  roadmap: [{ id: 'r-1', author: 'Naoki Sato', initials: 'NS', color: demoUser.color, time: '月曜日', body: 'P0は認証、ワークスペース、チャンネル、履歴取得、リアルタイム送受信で切りましょう。', reactions: [{ emoji: '🎯', count: 3 }] }],
