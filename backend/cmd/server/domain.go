...
type realtimeEvent struct {
	...
	PreviousActorHandle string   `json:"previous_actor_handle,omitempty"`
	Presence            string   `json:"presence,omitempty"`
...
type repository interface {
	...
	SearchMessages(context.Context, string, string, int) ([]Message, error)
	...
	ListThreadRoots(context.Context, string, int) (ThreadRootPage, error)
